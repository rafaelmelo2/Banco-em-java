...
public class SessionPage extends Thread {
    ...
    public void exibeSessionPage() {
        ...
        while (!validaWhile) {
            String opcao = msg.pergunta("\n\n==============Seja bem vindo(a) "+p1.getNome().toUpperCase() +" ao Banco-FAFAS==============\n1. Depositar\n2. Transferir\n3. Sair\nSaldo: "  + this.saldoArmazenado+"\n\n");
            ...
            switch (Integer.parseInt(opcao)) {
                case 1:
                    try {
                        String valorDeposita = msg.pergunta("Digite o valor a ser depositado:");//JOptionPane.showInputDialog("Digite o valor a ser depositado:");
                ...
                case 2:
                    try{
                        String valorTransfere = msg.pergunta("Digite o valor a ser transferido:");//JOptionPane.showInputDialog("Digite o valor a ser transferido:");
                        String idTransfere = msg.pergunta("Digite o ID do destinatário:"); //JOptionPane.showInputDialog("Digite o ID do destinatário:");
